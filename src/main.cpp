...
unsigned int nStakeTargetSpacing = 60; //  32 seconds block spacing
int64 nChainStartTime = 1394480376;
...
const string strMessageMagic = "Bitleu Signed Message:\n";
...
// Bitleu: increasing Nfactor gradually
...
// Bitleu block size.
		...
		else if(nHeight < 100001) // Launch start. Increasing block size on every blocks +1. ** Blocks: 1001 - 160000
        {
				nSubsidy = 125 * COIN;
		}	
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bitleu", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
  ...
  //vMerkleTree: 05b4eb8ba8 
        ...
        // Genesis block
        const char* pszTimestamp = "Bitleu relaunch.";
        CTransaction txNew;
...
assert(block.hashMerkleRoot == uint256("0x30cbad942f9fe09d06cabc91773860a827f3625a72eb2ae830c2c8844ffb6de2"));
        block.print();  
