...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Bitleud
You would need to create a configuration file Bitleu.conf in the default
wallet directory. Grant access to Bitleud.exe in anti-virus and firewall
...
Bitleud backupwallet <destination_backup_file>
Then shutdown ppcoind by
Bitleud stop
Start up the new Bitleud (0.3.0).
